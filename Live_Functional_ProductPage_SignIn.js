...
fixture `Live-Product Page - Start Trail /Sign In CTA`
.meta({type: "smoke"})
    .page `https://www.packtpub.com/free-ebook/serverless-design-patterns-and-best-practices/9781788620642`
    ...
    test('register for free-ebook', async t => {
        var  randEmail=(Math.round(Math.random()*100000)).toString(36)+"@email.com";
          ...
          //can't do the following line until recaptcha removed
        ...
        //Can't go further until recapcha removed
         ...
         test('product page - Sign in', async t => {
          ...
          await t
         .navigateTo(`https://www.packtpub.com/product/python-machine-learning-third-edition/9781789955750`)
