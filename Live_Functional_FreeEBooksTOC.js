...
fixture `Live - Free Ebook TOC`
    ...
    dataset.forEach(data => {
     ...
     await t
        ...
        //.navigateTo('https://packtpub.com')
        //.click(page.freelearning)
        .navigateTo(`https://packtpub.com/free-ebook/extreme-c/9781789343625`)
     ...
     test(`FreeEbook Page - LoggedInCh2 -  '${data.email}'`, async t => {
       ...
       test('Freelearning page - LoggedOutCh1', async t => {
            await t
            .navigateTo(`https://packtpub.com/free-learning`)
